...
def main():
    ...
    '''
    Start processing the mymd file by looking for chapter info and identifying
    every section.
    '''
    mymdLine = mymd_file.readline()
    instance_counter = 0
    while mymdLine:
        if (len(mymdLine) == 0 || mymdLine.isspace()):
            ...
            if mymdLine[0] == "*":
                ...
                html_file.write(process_button(section, [instance_counter]))
        mymdLine = mymd.readline()
